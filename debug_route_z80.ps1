...
# 1. Ensure Map File is accessible as z80.map for rename.py
if (Test-Path "build/z80/z80_eco.map") {
    Copy-Item "build/z80/z80_eco.map" "build/z80/z80.map" -Force
}
else {
    Write-Error "build/z80/z80_eco.map not found. Run run_z80_flow.py first."
    exit 1
}
